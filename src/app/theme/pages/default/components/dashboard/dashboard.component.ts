...
export class DashboardComponent implements OnInit, AfterViewInit {
  ...
  private getDashboardData(newAmCharts: any) {
    this.baseservice.get('dashboard').subscribe(
      (data: any) => {
        ...
        this.feesData = data.feesdetaillist[0];
        ...
        if (data.seatavailibility && data.seatavailibility.length > 0) {
          newAmCharts.makeChart('m_amcharts_4', {
            ...
            graphs: [
              {
                balloonText: 'Available Seats: <b>[[availableSeats]]</b>',
                fillAlphas: 0.8,
                lineAlpha: 0.2,
                type: 'column',
                valueField: 'availableSeats',
                fillColors: '#9b90e2', //#9b90e2
              },
            ],
            chartCursor: {
              categoryBalloonEnabled: false,
        ...
        //       {
        //         balloonText:
        //           'Class <b>[[className]]</b> Available Seats: <b>[[availableSeats]]</b>',
        //         fillAlphas: 0.9,
        //         lineAlpha: 0.2,
        ...
        //       {
        //         balloonText:
        //           'Class <b>[[className]]</b> Admitted Seats: <b>[[totalSeats - availableSeats]]</b>',
        //         fillAlphas: 0.9,
        //         lineAlpha: 0.2,
        //         title: 'Admitted Seats',
        //         type: 'column',
        //         fillColors: '#716aca',
        //       },
        //     ],
  ...
  public showabsentstudentlist(data: any) {
    ...
    // Assuming you've set up the datatable correctly
    this.datatable = $(
      this.elRef.nativeElement.querySelector('.m_datatable1')
    ).mDatatable({
      // datasource definition
      data: {
        type: 'local',
