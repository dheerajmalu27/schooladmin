...
const routes: Routes = [
  {
    ...
    "children": [
      ...
      {
        path: "fees-structure",
        loadChildren: () => import('./pages/default/components/fees-structure/fees-structure.module').then(x => x.FeesStructureModule)
      },
      // bus track Section
      {
        path: "bus-track",
      ...
      {
        path: "admission",
        loadChildren: () => import('./pages/default/components/admission/admission.module').then(x => x.AdmissionModule)
      },
      {
        path: "division-allocation",
        loadChildren: () => import('./pages/default/components/division-allocation/division-allocation.module').then(x => x.DivisionAllocationModule)
      },
      {
        path: "student-class-list-report",
        loadChildren: () => import('./pages/default/components/student-class-list-report/student-class-list-report.module').then(x => x.StudentClassListReportModule)
      },
      {
        path: "angular-ng",
        loadChildren: () => import('./pages/default/angular/ng-bootstrap/ng-bootstrap.module').then(x => x.NgBootstrapModule)
      },
