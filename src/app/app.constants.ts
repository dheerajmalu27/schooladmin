...
export const validationMessages = {
  oldPassword: {
    ...
    minLength(minLength: string) {
      return `Old password must be at least ${minLength} characters long`;
    },
    maxLength(maxLength: string) {
      return `Old password must be less than or equal to ${maxLength} characters long`;
    },
  },
  newPassword: {
    ...
    maxLength(maxLength: string) {
      return `New password must be less than or equal to ${maxLength} characters long`;
    },
  },
  password: {
    ...
    maxLength(maxLength: string) {
      return `Password must be less than or equal to ${maxLength} characters long`;
    },
  },
  comparePasswords: {
  ...
  name: {
    ...
    maxLength(maxLength: string) {
      return `Name must be less than or equal to ${maxLength} characters long.`;
    },
  },
  firstName: {
    ...
    // tslint:disable-next-line:max-line-length
    minLength(minLength: string) {
      return `FirstName must be at least ${minLength} characters long.`;
    },
    maxLength(maxLength: string) {
      return `FirstName must be less than or equal to ${maxLength} characters long.`;
    },
  },
  lastName: {
    ...
    // tslint:disable-next-line:max-line-length
    minLength(minLength: string) {
      return `LastName must be at least ${minLength} characters long.`;
    },
    maxLength(maxLength: string) {
      return `LastName must be less than or equal to ${maxLength} characters long.`;
    },
  },
  addrLine: {
    ...
    // tslint:disable-next-line:max-line-length
    minLength(minLength: string) {
      return `Address Line must be at least ${minLength} characters long.`;
    },
    maxLength(maxLength: string) {
      return `Address Line must be less than or equal to ${maxLength} characters long.`;
    },
  },
  city: {
    ...
    maxLength(maxLength: string) {
      return `City must be less than or equal to ${maxLength} characters long.`;
    },
  },
  cityId: {
    required: 'City is required.',
  ...
  state: {
    ...
    // tslint:disable-next-line:max-line-length
    minLength(minLength: string) {
      return `State must be at least ${minLength} characters long.`;
    },
    maxLength(maxLength: string) {
      return `State must be less than or equal to ${maxLength} characters long.`;
    },
  },
  stateId: {
    required: 'State is required.',
  ...
  country: {
    ...
    // tslint:disable-next-line:max-line-length
    minLength(minLength: string) {
      return `Country must be at least ${minLength} characters long.`;
    },
    maxLength(maxLength: string) {
      return `Country must be less than or equal to ${maxLength} characters long.`;
    },
  },
  pincode: {
    ...
    // tslint:disable-next-line:max-line-length
    minLength(minLength: string) {
      return `Pincode must be at least ${minLength} characters long.`;
    },
    maxLength(maxLength: string) {
      return `Pincode must be less than or equal to ${maxLength} characters long.`;
    },
    digitsOnly() {
  ...
  rate: {
    ...
    // tslint:disable-next-line:max-line-length
    minLength(minLength: string) {
      return `Rate must be at least ${minLength} characters long.`;
    },
    maxLength(maxLength: string) {
      return `Rate must be less than or equal to ${maxLength} characters long.`;
    },
    digitsOnly() {
      return `Only digits are allowed in Rate.`;
    },
  },
  phoneNumber: {
    ...
    // tslint:disable-next-line:max-line-length
    minLength(minLength: string) {
      return `Phone Number must be at least ${minLength} characters long.`;
    },
    maxLength(maxLength: string) {
      return `Phone Number must be less than or equal to ${maxLength} characters long.`;
    },
    digitsOnly() {
  ...
  mobile: {
    ...
    // tslint:disable-next-line:max-line-length
    minLength(minLength: string) {
      return `Mobile Number must be at least ${minLength} characters long.`;
    },
    maxLength(maxLength: string) {
      return `Mobile Number must be less than or equal to ${maxLength} characters long.`;
    },
    digitsOnly() {
  ...
  otp: {
    ...
    // tslint:disable-next-line:max-line-length
    minLength(minLength: string) {
      return `OTP must be  ${minLength} digits long`;
    },
    maxLength(maxLength: string) {
      return `OTP must be  ${maxLength} digits long`;
    },
    digitsOnly() {
      return `Only digits are allowed in OTP.`;
    },
  },
  title: {
    ...
    maxLength(maxLength: string) {
      return `Title must be max  ${maxLength} characters long`;
    },
    digitsOnly() {
      return `Only digits are allowed in OTP.`;
    },
  ...
  description: {
    ...
    maxLength(maxLength: string) {
      return `Description must be less than or equal to ${maxLength} characters long.`;
    },
  },
  docUrl: {
  ...
  email: {
    ...
    minLength(minLength: string) {
      return `Email must be at least ${minLength} characters long.`;
    },
    maxLength(maxLength: string) {
      return `Email must be less than or equal to ${maxLength} characters long.`;
    },
  },
  primaryMobile: {
    required: 'Mobile Number is required.',
